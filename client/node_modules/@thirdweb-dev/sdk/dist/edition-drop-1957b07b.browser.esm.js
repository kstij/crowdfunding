...
class EditionDrop extends StandardErc1155 {
  constructor(network, _address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new ContractWrapper(network, _address, abi, _options, storage);
