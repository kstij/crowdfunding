...
var QueryParams = require('./QueryParams-142dd062.cjs.prod.js');
var zod = require('zod');
...
const FEATURE_NFT_UPDATABLE_METADATA = {
  ...
  abis: [INFTMetadataAbi__default["default"]],
  features: {}
};
const FEATURE_NFT = {
  name: "ERC721",
...
class Erc721LoyaltyCard {
  constructor(contractWrapper) {
    QueryParams._defineProperty(this, "featureName", FEATURE_NFT_LOYALTY_CARD.name);
    QueryParams._defineProperty(this, "contractWrapper", void 0);
    /**
     ...
     * ```
     */
    QueryParams._defineProperty(this, "cancel", /* @__PURE__ */buildTransactionFunction(async tokenId => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "cancel",
        args: [tokenId]
     ...
     * ```
     */
    QueryParams._defineProperty(this, "revoke", /* @__PURE__ */buildTransactionFunction(async tokenId => {
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "revoke",
        args: [tokenId]
...
class Erc721UpdatableMetadata {
  constructor(contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_NFT_UPDATABLE_METADATA.name);
    QueryParams._defineProperty(this, "contractWrapper", void 0);
    QueryParams._defineProperty(this, "storage", void 0);
    /**
     ...
     * ```
     */
    QueryParams._defineProperty(this, "update", /* @__PURE__ */buildTransactionFunction(async (tokenId, metadata) => {
      const uri = await uploadOrExtractURI(metadata, this.storage);
      return Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
        method: "setTokenURI",
...
class Erc721 {
  ...
  constructor(contractWrapper, storage, chainId) {
    ...
    QueryParams._defineProperty(this, "loyaltyCard", void 0);
    QueryParams._defineProperty(this, "updatableMetadata", void 0);
    QueryParams._defineProperty(this, "contractWrapper", void 0);
    QueryParams._defineProperty(this, "storage", void 0);
    QueryParams._defineProperty(this, "_chainId", void 0);
    /**
...
const SignerWithRestrictionsSchema = /* @__PURE__ */zod.z.object({
  signer: AddressOrEnsSchema,
  isAdmin: /* @__PURE__ */zod.z.boolean(),
  restrictions: AccessRestrictionsSchema
});
const SignerWithRestrictionsBatchSchema = /* @__PURE__ */zod.z.array(SignerWithRestrictionsSchema);
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([await EditionDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./edition-drop-7e48b0ba.cjs.prod.js'); }), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./edition-5479359b.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./marketplace-8705b2ea.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceV3Initializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./marketplacev3-0b234a14.cjs.prod.js'); }), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./multiwrap-6a746b53.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./nft-collection-effc62d6.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./nft-drop-53b72095.cjs.prod.js'); }), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./pack-5ab29768.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./signature-drop-4eabf07e.cjs.prod.js'); }), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./split-4c8bb2c2.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./token-drop-983ecd5c.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./token-b2822136.cjs.prod.js'); }), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider, storage), Promise.resolve().then(function () { return require('./vote-ec6cad6b.cjs.prod.js'); }), provider.getNetwork()]);
...
class Account {
  constructor(contractWrapper) {
    QueryParams._defineProperty(this, "featureName", FEATURE_ACCOUNT.name);
    QueryParams._defineProperty(this, "contractWrapper", void 0);
    ...
    QueryParams._defineProperty(this, "grantAccess", /* @__PURE__ */buildTransactionFunction(async (signerAddress, restrictions) => {
      ...
      const roleRestrictions = {
        ...
        maxValuePerTransaction: ethers.utils.parseEther(parsedRestrictions.nativeTokenLimitPerTransaction),
     ...
     * @twfeature Account
     */
    QueryParams._defineProperty(this, "setAccess", /* @__PURE__ */buildTransactionFunction(async permissionsSnapshot => {
      /**
       * All cases
       *
       * - Add new admin :check:
      ...
      for (const newScoped of allNewScoped) {
        if (!allCurrentScoped.includes(newScoped)) {
          // Derive role for target signer.
          const role = ethers.utils.solidityKeccak256(["string"], [newScoped]);
      ...
      for (const currentScoped of allCurrentScoped) {
        if (allNewScoped.includes(currentScoped)) {
          // Derive role for target signer.
          const role = ethers.utils.solidityKeccak256(["string"], [currentScoped]);
  ...
  async getFactory() {
    ...
    const wrapper = new ContractWrapper(chainId, factoryAddress, IAccountFactory__default["default"], this.contractWrapper.options, this.contractWrapper.storage);
...
class AccountFactory {
  constructor(contractWrapper) {
    QueryParams._defineProperty(this, "featureName", FEATURE_ACCOUNT_FACTORY.name);
    QueryParams._defineProperty(this, "contractWrapper", void 0);
    // utilities
    QueryParams._defineProperty(this, "events", void 0);
    /*********************************
     ...
     */
    QueryParams._defineProperty(this, "createAccount", /* @__PURE__ */buildTransactionFunction(async (accountAdmin, extraData) => {
...
class ContractPublisher extends RPCConnectionHandler {
  constructor(_network, options, storage) {
    ...
    this.storage = storage;
    this.publisher = new ContractWrapper(_network, getContractPublisherAddress(), ContractPublisherAbi__default["default"], options, storage);
  }
  updateSignerOrProvider(network) {
    super.updateSignerOrProvider(network);
...
exports.SignerWithRestrictionsBatchSchema = SignerWithRestrictionsBatchSchema;
exports.SignerWithRestrictionsSchema = SignerWithRestrictionsSchema;
