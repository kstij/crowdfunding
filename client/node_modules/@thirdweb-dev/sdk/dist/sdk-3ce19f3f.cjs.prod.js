...
var contractPublisher = require('./contract-publisher-a8f92f66.cjs.prod.js');
    ...
    if (extendedMetadata && extendedMetadata.factoryDeploymentData?.implementationAddresses) {
      ...
      try {
        ...
        if (network && implementation) {
          ...
          const contract = new contractPublisher.ContractWrapper(provider, implementation, contractPublisher.getAllPluginsAbi, {}, storage);
...
class ContractFactory extends contractPublisher.ContractWrapper {
  constructor(factoryAddr, network, storage, _options) {
    super(network, factoryAddr, TWFactoryAbi__default["default"], _options, storage);
    QueryParams._defineProperty(this, "storage", void 0);
...
class ContractDeployer extends contractPublisher.RPCConnectionHandler {
  constructor(network, _options, storage) {
     ...
     * @returns the address of the deployed contract
     */
    QueryParams._defineProperty(this, "deployLoyaltyCard", /* @__PURE__ */contractPublisher.buildDeployTransactionFunction(async (metadata, options) => {
