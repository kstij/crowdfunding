 ...
 * @param storage
 */
export declare function verifyThirdwebPrebuiltImplementation(contractName: string, chainId: number, explorerAPIUrl: string, explorerAPIKey: string, storage: ThirdwebStorage, clientId?: string, secretKey?: string, constructorArgs?: ConstructorParamMap): Promise<string | string[]>;
/**
 * @public
 *
