...
const ThirdwebSDKProvider = _ref2 => {
  ...
  if (!clientId) {
    sdk.checkClientIdOrSecretKey("No clientId provided in ThirdwebSDK. You will have limited access to thirdweb's services for storage, RPC, and account abstraction. You can get a clientId from https://thirdweb.com/create-api-key", clientId, undefined);
  }
