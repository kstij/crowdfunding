...
var CoinbaseWalletConnector = class extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!_classPrivateFieldGet(this, _provider)) {
      let CoinbaseWalletSDK = (await import("./dist-27DGOUVR.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-N7DQ2RXJ.js.map
