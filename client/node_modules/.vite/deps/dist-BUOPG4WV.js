      ...
      for (i2 = 0; i2 < maxDataSize; i2++) {
        for (r = 0; r < ecTotalBlocks; r++) {
          if (i2 < dcData[r].length) {
            data2[index++] = dcData[r][i2];
          }
        }
      }
      for (i2 = 0; i2 < ecCount; i2++) {
        for (r = 0; r < ecTotalBlocks; r++) {
          data2[index++] = ecData[r][i2];
        }
      }
      return data2;
    }
...
var cubicBezierAsString = ([a, b, c2, d2]) => `cubic-bezier(${a}, ${b}, ${c2}, ${d2})`;
...
function rt() {
  var e;
  const o = (e = G.state.themeMode) != null ? e : "dark", r = { light: { foreground: { 1: "rgb(20,20,20)", 2: "rgb(121,134,134)", 3: "rgb(158,169,169)" }, background: { 1: "rgb(255,255,255)", 2: "rgb(241,243,243)", 3: "rgb(228,231,231)" }, overlay: "rgba(0,0,0,0.1)" }, dark: { foreground: { 1: "rgb(228,231,231)", 2: "rgb(148,158,158)", 3: "rgb(110,119,119)" }, background: { 1: "rgb(20,20,20)", 2: "rgb(39,42,42)", 3: "rgb(59,64,64)" }, overlay: "rgba(255,255,255,0.1)" } }[o];
...
var h = { getPreset(e) {
  ...
  const e = document.querySelector(":root"), { themeVariables: o } = G.state;
  if (e) {
...
T2.styles = [h.globalCss, at], F2([property({ type: Boolean })], T2.prototype, "disabled", 2), F2([property()], T2.prototype, "iconLeft", 2), F2([property()], T2.prototype, "iconRight", 2), F2([property()], T2.prototype, "onClick", 2), F2([property()], T2.prototype, "variant", 2), T2 = F2([customElement("wcm-button")], T2);
...
var fe = class extends LitElement {
  render() {
    return html`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${v.WALLET_CONNECT_LOGO} <button @click="${F.close}">${v.CROSS_ICON}</button></div>`;
  }
};
...
var c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e, o) {
  ...
  const { walletImages: r } = f.state;
  return r != null && r[e] ? r[e] : o ? q.getWalletImageUrl(o) : "";
  ...
  const { walletConnectUri: o } = d.state, { mobile: r, name: a } = e, t = r == null ? void 0 : r.native, l = r == null ? void 0 : r.universal;
  c.setRecentWallet(e);
  function i2(s) {
    let $ = "";
    t ? $ = i.formatUniversalUrl(t, s, a) : l && ($ = i.formatNativeUrl(l, s, a)), i.openHref($, "_self");
  }
  o && i2(o);
}, handleAndroidLinking() {
  const { walletConnectUri: e } = d.state;
  e && (i.setWalletConnectAndroidDeepLink(e), i.openHref(e, "_self"));
}, async handleUriCopy() {
  const { walletConnectUri: e } = d.state;
  if (e)
    try {
      await navigator.clipboard.writeText(e), Q.openToast("Link copied", "success");
    } catch {
      Q.openToast("Failed to copy", "error");
    }
}, getCustomImageUrls() {
  const { walletImages: e } = f.state, o = Object.values(e != null ? e : {});
  ...
  i.openHref(c.EXPLORER_WALLET_URL, "_blank");
  ...
  N.setData({ Wallet: e });
  const o = i.isMobile(), { isDesktop: r, isWeb: a, isMobile: t } = c.getCachedRouterWalletPlatforms();
...
var ne = class extends LitElement {
  constructor() {
    super(), this.open = false, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = Q.subscribe((e) => {
      e.open ? (this.open = true, this.timeout = setTimeout(() => Q.closeToast(), 2200)) : (this.open = false, clearTimeout(this.timeout));
    });
  }
  disconnectedCallback() {
    var e;
    (e = this.unsubscribe) == null || e.call(this), clearTimeout(this.timeout), Q.closeToast();
  }
  render() {
    const { message: e, variant: o } = Q.state, r = { "wcm-success": o === "success", "wcm-error": o === "error" };
...
var Dt = { generate(e, o, r) {
  const a = "#141414", t = "#ffffff", l = [], i2 = _t(e, "Q"), s = o / i2.length, $ = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  $.forEach(({ x: y, y: u }) => {
  ...
  const f2 = Math.floor((r + 25) / s), Ne = i2.length / 2 - f2 / 2, Ze = i2.length / 2 + f2 / 2 - 1, Se = [];
  i2.forEach((y, u) => {
    y.forEach((O, b) => {
...
var j = class extends LitElement {
  ...
  svgTemplate() {
    const e = G.state.themeMode === "light" ? this.size : this.size - 36;
    return svg`<svg height="${e}" width="${e}">${Dt.generate(this.uri, e, e / 4)}</svg>`;
  }
  render() {
    const e = { "wcm-dark": G.state.themeMode === "dark" };
...
j.styles = [h.globalCss, Nt], q2([property()], j.prototype, "uri", 2), q2([property({ type: Number })], j.prototype, "size", 2), q2([property()], j.prototype, "imageId", 2), q2([property()], j.prototype, "walletId", 2), q2([property()], j.prototype, "imageUrl", 2), j = q2([customElement("wcm-qrcode")], j);
...
var L = class extends LitElement {
  ...
  handleClick() {
    T.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var e;
...
var We = class extends LitElement {
  ...
  async preloadListings() {
    if (f.state.enableExplorer) {
      await q.getRecomendedWallets(), d.setIsDataLoaded(true);
      const { recomendedWallets: e } = q.state, o = e.map((r) => c.getWalletIcon(r));
  ...
  async preloadData() {
    try {
      ...
      console.error(e), Q.openToast("Failed preloading", "error");
    }
  }
};
...
var Qe = class extends LitElement {
  constructor() {
    super(), this.unsubscribeTheme = void 0, h.setTheme(), this.unsubscribeTheme = G.subscribe(h.setTheme);
  }
  disconnectedCallback() {
    var e;
...
var Ie = class extends LitElement {
  ...
  render() {
    const { recomendedWallets: e } = q.state, o = [...e, ...e], r = i.RECOMMENDED_WALLET_AMOUNT * 2;
...
var D = class extends LitElement {
  ...
  svgLoaderTemplate() {
    var e, o;
    const r = (o = (e = G.state.themeVariables) == null ? void 0 : e["--wcm-wallet-icon-large-border-radius"]) != null ? o : h.getPreset("--wcm-wallet-icon-large-border-radius");
    let a = 0;
...
var G2 = { manualWallets() {
  var e, o;
  const { mobileWallets: r, desktopWallets: a } = f.state, t = (e = G2.recentWallet()) == null ? void 0 : e.id, l = i.isMobile() ? r : a, i2 = l == null ? void 0 : l.filter((s) => t !== s.id);
  return (o = i.isMobile() ? i2 == null ? void 0 : i2.map(({ id: s, name: $, links: f2 }) => ({ id: s, name: $, mobile: f2, links: f2 })) : i2 == null ? void 0 : i2.map(({ id: s, name: $, links: f2 }) => ({ id: s, name: $, desktop: f2, links: f2 }))) != null ? o : [];
}, recentWallet() {
  return c.getRecentWallet();
}, recomendedWallets(e = false) {
  var o;
  const r = e || (o = G2.recentWallet()) == null ? void 0 : o.id, { recomendedWallets: a } = q.state;
...
var Ee = class extends LitElement {
  render() {
    const { explorerExcludedWalletIds: e, enableExplorer: o } = f.state, r = e !== "ALL" && o, a = Z.manualWalletsTemplate(), t = Z.recomendedWalletsTemplate();
...
var Me = class extends LitElement {
  render() {
    const { termsOfServiceUrl: e, privacyPolicyUrl: o } = f.state;
...
var Le = class extends LitElement {
  ...
  render() {
    ...
    const $ = Boolean(s.length);
    return html`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${v.QRCODE_ICON}"></wcm-modal-header>${$ ? html`<wcm-modal-content><div>${s} ${i2 ? html`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
...
var ae = class extends LitElement {
  constructor() {
    super(), this.open = false, this.active = false, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = F.subscribe((e) => {
  ...
  onCloseModal(e) {
    e.target === e.currentTarget && F.close();
  }
  onOpenModalEvent() {
  ...
  addKeyboardEvents() {
    this.abortController = new AbortController(), window.addEventListener("keydown", (e) => {
      var o;
      e.key === "Escape" ? F.close() : e.key === "Tab" && ((o = e.target) != null && o.tagName.includes("wcm-") || this.containerEl.focus());
...
var Ae = class extends LitElement {
  ...
  render() {
    const { recomendedWallets: e } = q.state, o = G2.manualWallets(), r = [...e, ...o].reverse().slice(0, 4);
...
var me = class extends LitElement {
  ...
  openDesktopApp() {
    const { walletConnectUri: e } = d.state, o = i.getWalletRouterData();
    c.setRecentWallet(o), e && this.onFormatAndRedirect(e);
  }
  render() {
    const { name: e, id: o, image_id: r } = i.getWalletRouterData(), { isMobile: a, isWeb: t } = c.getCachedRouterWalletPlatforms();
...
var he = class extends LitElement {
  ...
  openMobileApp(e = false) {
    const { walletConnectUri: o } = d.state, r = i.getWalletRouterData();
  ...
  render() {
    const { name: e, id: o, image_id: r, app: a, mobile: t } = i.getWalletRouterData(), { isWeb: l } = c.getCachedRouterWalletPlatforms(), i2 = a == null ? void 0 : a.ios, s = t == null ? void 0 : t.universal;
...
var je = class extends LitElement {
  render() {
    const { name: e, id: o, image_id: r } = i.getWalletRouterData(), { isDesktop: a, isWeb: t } = c.getCachedRouterWalletPlatforms();
...
var U = class extends LitElement {
  constructor() {
    super(...arguments), this.loading = !q.state.wallets.listings.length, this.firstFetch = !q.state.wallets.listings.length, this.search = "", this.endReached = false, this.intersectionObserver = void 0, this.searchDebounce = c.debounce((e) => {
      e.length >= 1 ? (this.firstFetch = true, this.endReached = false, this.search = e, q.resetSearch(), this.fetchWallets()) : this.search && (this.search = "", this.endReached = this.isLastPage(), q.resetSearch());
    });
  }
  firstUpdated() {
  ...
  isLastPage() {
    const { wallets: e, search: o } = q.state, { listings: r, total: a } = this.search ? o : e;
    return a <= De || r.length >= a;
  }
  async fetchWallets() {
    var e;
    const { wallets: o, search: r } = q.state, { listings: a, total: t, page: l } = this.search ? r : o;
    if (!this.endReached && (this.firstFetch || t > De && a.length < t))
      try {
        this.loading = true;
        const i2 = (e = d.state.chains) == null ? void 0 : e.join(","), { listings: s } = await q.getWallets({ page: this.firstFetch ? 1 : l + 1, entries: De, search: this.search, version: 2, chains: i2 }), $ = s.map((f2) => c.getWalletIcon(f2));
        await Promise.all([...$.map(async (f2) => c.preloadImage(f2)), i.wait(300)]), this.endReached = this.isLastPage();
      } catch (i2) {
        console.error(i2), Q.openToast(c.getErrorMessage(i2), "error");
      } finally {
        this.loading = false, this.firstFetch = false;
      }
  }
  onConnect(e) {
    i.isAndroid() ? c.handleMobileLinking(e) : c.goToConnectingView(e);
  }
  onSearchChange(e) {
  ...
  render() {
    const { wallets: e, search: o } = q.state, { listings: r } = this.search ? o : e, a = this.loading && !r.length, t = this.search.length >= 3;
    let l = Z.manualWalletsTemplate(), i2 = Z.recomendedWalletsTemplate(true);
    t && (l = l.filter(({ values: f2 }) => c.caseSafeIncludes(f2[0], this.search)), i2 = i2.filter(({ values: f2 }) => c.caseSafeIncludes(f2[0], this.search)));
    const s = !this.loading && !r.length && !i2.length, $ = { "wcm-loading": a, "wcm-end-reached": this.endReached || !this.loading, "wcm-empty": s };
    return html`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${classMap($)}"><div class="wcm-grid">${a ? null : l} ${a ? null : i2} ${a ? null : r.map((f2) => html`${f2 ? html`<wcm-wallet-button imageId="${f2.image_id}" name="${f2.name}" walletId="${f2.id}" .onClick="${() => this.onConnect(f2)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${s ? html`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!s && this.loading ? html`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
...
var we = class extends LitElement {
  ...
  render() {
    const { name: e, id: o, image_id: r } = i.getWalletRouterData(), { isMobile: a, isDesktop: t } = c.getCachedRouterWalletPlatforms(), l = i.isMobile();
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
//# sourceMappingURL=dist-BUOPG4WV.js.map
